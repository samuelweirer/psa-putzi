...
const mockLocations: Location[] = [
  {
    ...
    notes: 'Hauptsitz mit Verwaltung und IT-Abteilung',
  },
  {
    id: '2',
    name: 'Lager Hamburg',
    addressLine1: 'Hafenstraße 45',
    addressLine2: 'Halle 7',
    city: 'Hamburg',
    postalCode: '20095',
    country: 'Deutschland',
    locationType: 'warehouse',
    notes: 'Warenlager und Logistikzentrum',
  },
  {
    id: '3',
    name: 'Rechenzentrum Frankfurt',
    addressLine1: 'Datacenter Allee 1',
    city: 'Frankfurt am Main',
    postalCode: '60311',
    country: 'Deutschland',
    locationType: 'datacenter',
    notes: 'Primäres Rechenzentrum für alle Services',
  },
];
...
export function LocationListPage() {
  ...
  const [locationToDelete, setLocationToDelete] = useState<{ id: string; name: string } | null>(
    null
  );

  // In Sprint 4, this will fetch from: GET /api/customers/:customerId/locations
  ...
  const handleDeleteConfirm = async (locationId: string) => {
    ...
    // In Sprint 4: DELETE /api/locations/:id
